...
const ytdl = require('ytdl-core'); // New library for downloading YouTube videos
    ...
    try {
        ...
        ytdl(videoURL, { format: audioFormat })
            .on('error', (err) => {
                ...
                res.status(500).send('Error while downloading the audio stream.');
            })
            .pipe(res);
